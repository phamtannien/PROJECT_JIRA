...
export default function Info(props) {
  ...
  const renderDes = () => {
    const jsxDes = HTMLReactParser(`${taskDetailModal.description}`);
    return (
      <div>
        {visibleEditor ? <div>
          <Editor
          ...
          <div className="modal-header">
            <div className="task-title">
              ...
              <select name="typeId" onChange={handleChange}>
                {arrTaskType.map((tp, idx) => {
                  return (
                    <option key={idx} value={tp.id}>
                      {" "}
                      {tp.taskType}
                    </option>
                  );
              ...
              <div className="row">
                ...
                <div className="col-4">
                  ...
                  <div className="assignees">
                    <h6>ASSIGNEES</h6>
                    <div className="row">
                      {taskDetailModal.assigness.map((user, idx) => {               
                            ...
                            <p className="name mt-1 ml-1">
                              ...
                              <i
                                ...
                                onClick={()=>{
                                  dispatch({
                                    type:HANDLE_CHANGE_POST_API_SAGA,
                                    actionType: REMOVE_USER_ASIGNESS,
                                    userId: user.id
                                  })
                  ...
                  <div className="priority" style={{ marginBottom: 20 }}>
                    ...
                    >
                      {arrPriority.map((item, idx) => {
                        return (
                          <option key={idx} value={item.priorityId}>
                            {item.priority}
                          </option>
                        );
                      })}
